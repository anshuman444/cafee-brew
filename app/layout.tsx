...
export const metadata: Metadata = {
  ...
  title: {
    default: "Coffee & Joy - Cafe-brew | Premium Coffee Shop Experience",
    template: "%s | Coffee & Joy - Cafe-brew", // %s will be replaced with page-specific title
  },
  description:
    "Experience the joy of exceptional coffee at Cafe-brew. We craft every cup with passion and warmth, offering rich espresso blends, classic drip coffee, smooth cold brews, and flavorful latte varieties. Founded in 2000, we're committed to quality, sustainability, and creating memorable coffee experiences.",
  keywords: [
    "coffee shop",
    "coffee",
    "cafe",
  ...
  openGraph: {
    ...
    siteName: "Coffee & Joy - Cafe-brew",
    title: "Coffee & Joy - Cafe-brew | Premium Coffee Shop Experience",
    description:
      "Experience the joy of exceptional coffee at Cafe-brew. We craft every cup with passion and warmth, offering rich espresso blends, classic drip coffee, smooth cold brews, and flavorful latte varieties.",
    images: [
      {
        url: "/assets/logo.svg", // Social sharing image (ideal: 1200x630px)
        width: 1200,
        height: 630,
        alt: "Coffee & Joy - Cafe-brew Logo",
      },
    ],
  },
  twitter: {
  ...
  applicationName: "Coffee & Joy - Cafe-brew",
  ...
  return (
    <html lang="en">
      ...
      <body className={`${cormorant_upright.variable} ${open_sans.variable}`}>
        <ScrollProvider>
          <Header />
          {/* {children} renders the page component wrapped in animated route transitions */}
